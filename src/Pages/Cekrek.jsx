...
export default function Cekrek() {
  ...
  if (info) {
    content = (
      <div className="p-2 bg-mainBtn my-5 rounded">
        <p className="text-green-500 mb-2 text-xs font-semibold">Success !</p>
        <div>
          <h4 className="font-bold text-mainBg">
            Bank/E-Wallet : {info[0].accountBank}
          </h4>
          <h4 className="font-bold text-mainBg">
            Name : {info[0].accountName}
          </h4>
          <h4 className="font-bold text-mainBg">
            Rek/Number : {info[0].accountNumber}
          </h4>
        </div>
      </div>
    );
  ...
  if (info == undefined) {
    content = (
      <div className="p-2 bg-mainBtn dark:bg-mainBg my-5 rounded">
        <p className="text-red-500 font-semibold my-2 text-xs">
          Data not found !
        </p>
      </div>
    );
